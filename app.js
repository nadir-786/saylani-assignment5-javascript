...
//     <meta charset="UTF-8">
//     <meta name="viewport" content="width=device-width, initial-scale=1.0">
//     <title>Javascrip Script Tag In Head Demo</title>
// <script>
// alert("Working in Head Tag");
// </script>
// </head>
// <body>
// <h1>Practise of Script Tag Demo in Head TAg</h1>
// </body>
// </html>
...
//     <meta charset="UTF-8">
//     <meta name="viewport" content="width=device-width, initial-scale=1.0">
//     <title>Javascrip Script Tag In Body Demo</title>

// </head>
// <body>
// <script>
// alert("Working on Before Html File");
// </script>
// <h1>Practise of Script Tag Demo in Body Tag (before Html Pages)</h1>
// </body>  
// </html>
...
// <body>
// <div>
// <h1>Practise of Script Tag Demo in Body Tag (inside Html Pages)</h1>
//     <button>Click Me</button>
// <script>
// alert("Working on Inside Html pages");
// </script>
// </div>
// </body>
// </html>
...
// </div>
// <script>
// alert("Working After Html Pages");
// </script>
// </body>
// </html>
...
// var email;
// email = "nadirali.abro.786@gmail.com";
...
// document.write("<h1>Yeh! I write HTML content through Javascript</h1>")
...
// var birthYear;
// birthYear = 2001;
// document.write("My birth year "+birthYear+"<br />"+"Data type of my decleared variable is "+typeof(birthYear));
...
//  var num2 = 5;
//  var multiply = num1/num2;
//  document.write("Division of "+num1+" and "+num2+" is "+multiply);

////TASK NO 3/////
// var myNum;
// document.write("Value agter variable declaration is "+ myNum+"<br>");
// myNum = 5;
...
// var ticketPrice = 600;
// var ticketQty = 5;
// var ticketBill = ticketPrice*ticketQty;
// document.write("Total cost to buy "+ticketQty+" tickets to a movie is "+ticketBill+"PKR.");
...
// document.write("You wwill need "+reqSnack+" "+snackName+" to last you until the rip old age of: "+maxAge);
...
//  var userCity = prompt("Please Enter Your City Name");
//  if(userCity === "Karachi"){
...
// var trafficSignal = prompt("Please Enter the Color of Toad Traffic Signal")
...
// var remainingFuel = parseFloat(prompt("What is the remaining Fuel in car?"));
// alert(remainingFuel)
// if (remainingFuel < 0.25) {
//     alert("Please refil the fuel in the car");
// }
...
// var init1 = prompt("Enter the Interger No 1");
// var init2 = prompt("Enter the Interger No 2");
// if(init1-init2 > 0){
//     alert("The "+init1 + " is bigger then "+init2)
// }else if(init2-init1 > 0){
//     alert("The "+init2 + " is bigger then "+init1)
// }else if(init1 = init2){
//     alert("The "+init1 + " is equal to "+init2)
// }
